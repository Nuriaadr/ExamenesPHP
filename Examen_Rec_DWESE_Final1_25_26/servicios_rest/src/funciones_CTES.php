...
function deGuardia($id_usuario)
{
    ...
    if ($sentencia->rowCount() > 0) {
        ...
        $respuesta["mensaje"] = "El usuario no tiene guardias en la BD";
...
function usuariosGuardia($dia, $hora)
{
    ...
    if ($sentencia->rowCount() > 0) {
        $respuesta["equipo"] = $sentencia->fetchAll(PDO::FETCH_ASSOC);
    } else
        $respuesta["mensaje"] = "El usuario no tiene guardias en la BD";
...
function usuario($id_usuario)
{
    ...
    if ($sentencia->rowCount() > 0) {
        ...
        $respuesta["mensaje"] = "El usuario no está en la BD";
