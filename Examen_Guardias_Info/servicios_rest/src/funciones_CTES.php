...
function deGuardia($dia, $hora)
{
    ...
    try {
        $consulta = "select  horario_lectivo.*, usuarios.nombre from horario_lectivo join usuarios on horario_lectivo.usuario = usuarios.id_usuario where dia=? and hora=?";
        $sentencia = $conexion->prepare($consulta);
